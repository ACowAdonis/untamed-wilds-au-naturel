...
public class ModelCamel extends AdvancedEntityModel<EntityCamel> {
   ...
   public ModelCamel() {
      ...
      this.arm_right_1.addBox(-2.5F, -1.5F, -3.0F, 5.0F, 12.0F, 6.0F, 0.0F);
      ...
      this.body_main.addBox(-5.0F, -6.0F, -10.0F, 10.0F, 12.0F, 24.0F, 0.0F);
      ...
      this.leg_right_thigh.addBox(-2.5F, -1.5F, -4.0F, 5.0F, 10.0F, 8.0F, 0.0F);
      this.setRotateAngle(this.leg_right_thigh, 0.13665928F, 0.0F, 0.0F);
      ...
      this.leg_right_hair.addBox(-3.0F, 0.0F, -3.5F, 6.0F, 9.0F, 7.0F, 0.0F);
      this.setRotateAngle(this.leg_right_hair, -0.13665928F, 0.0F, 0.0F);
      this.neck_hair_2 = new AdvancedModelBox(this, 88, 45);
      this.neck_hair_2.setRotationPoint(0.0F, -0.6F, -2.0F);
      this.neck_hair_2.addBox(-3.0F, -3.1F, -7.3F, 6.0F, 8.0F, 8.0F, 0.0F);
      this.setRotateAngle(this.neck_hair_2, -0.22759093F, 0.0F, 0.0F);
      ...
      this.arm_left_hair.addBox(-3.0F, 0.0F, -3.5F, 6.0F, 9.0F, 7.0F, 0.0F);
      ...
      this.setRotateAngle(this.leg_right_calf, 0.31869712F, 0.0F, 0.0F);
      this.body_hump_back = new AdvancedModelBox(this, 30, 46);
      this.body_hump_back.setRotationPoint(0.0F, -5.8F, 9.0F);
      this.body_hump_back.addBox(-3.0F, -6.0F, -6.0F, 6.0F, 8.0F, 10.0F, 0.0F);
      this.setRotateAngle(this.body_hump_back, -0.045553092F, 0.0F, 0.0F);
      ...
      this.arm_right_2.addBox(-1.5F, 0.0F, -1.5F, 3.0F, 17.0F, 3.0F, 0.0F);
      ...
      this.arm_left_1.addBox(-2.5F, -1.5F, -3.0F, 5.0F, 12.0F, 6.0F, 0.0F);
      ...
      this.arm_right_hair.addBox(-3.0F, 0.0F, -3.5F, 6.0F, 9.0F, 7.0F, 0.0F);
      this.body_hump_front = new AdvancedModelBox(this, 0, 48);
      this.body_hump_front.setRotationPoint(0.0F, -6.0F, -3.0F);
      this.body_hump_front.addBox(-3.0F, -6.0F, -6.0F, 6.0F, 8.0F, 8.0F, 0.0F);
      this.setRotateAngle(this.body_hump_front, 0.13665928F, 0.0F, 0.0F);
      this.tail = new AdvancedModelBox(this, 62, 49);
      this.tail.setRotationPoint(0.0F, -5.0F, 14.0F);
      this.tail.addBox(-1.5F, 0.0F, -1.5F, 3.0F, 12.0F, 3.0F, 0.0F);
      this.setRotateAngle(this.tail, 0.22759093F, 0.0F, 0.0F);
      this.leg_left_thigh = new AdvancedModelBox(this, 44, 0);
      this.leg_left_thigh.setRotationPoint(3.8F, -2.0F, 11.5F);
      this.leg_left_thigh.addBox(-2.5F, -1.5F, -4.0F, 5.0F, 10.0F, 8.0F, 0.0F);
      this.setRotateAngle(this.leg_left_thigh, 0.13665928F, 0.0F, 0.0F);
      this.neck_2 = new AdvancedModelBox(this, 58, 34);
      this.neck_2.setRotationPoint(0.0F, 0.0F, -10.2F);
      this.neck_2.addBox(-2.5F, -2.5F, -8.5F, 5.0F, 5.0F, 10.0F, 0.0F);
      this.setRotateAngle(this.neck_2, -1.3658947F, 0.0F, 0.0F);
      ...
      this.leg_left_hair.addBox(-3.0F, 0.0F, -3.5F, 6.0F, 9.0F, 7.0F, 0.0F);
      this.setRotateAngle(this.leg_left_hair, -0.13665928F, 0.0F, 0.0F);
      ...
      this.neck_hair_1.addBox(-3.0F, -4.0F, -12.0F, 6.0F, 8.0F, 12.0F, 0.0F);
      ...
      this.setRotateAngle(this.leg_left_calf, 0.31869712F, 0.0F, 0.0F);
      this.arm_left_2 = new AdvancedModelBox(this, 84, 20);
      this.arm_left_2.setRotationPoint(0.01F, 9.05F, 0.01F);
      this.arm_left_2.addBox(-1.5F, 0.0F, -1.5F, 3.0F, 17.0F, 3.0F, 0.0F);
      ...
      this.body_hump_centre.addBox(-3.0F, -6.0F, -6.0F, 6.0F, 8.0F, 12.0F, 0.0F);
      this.setRotateAngle(this.body_hump_centre, -0.045553092F, 0.0F, 0.0F);
      this.head_hair = new AdvancedModelBox(this, 96, 29);
      this.head_hair.setRotationPoint(0.0F, -3.0F, 0.8F);
      this.head_hair.addBox(-3.0F, -3.1F, -7.3F, 6.0F, 8.0F, 8.0F, 0.0F);
      ...
      this.neck_1.addBox(-2.5F, -2.5F, -12.0F, 5.0F, 5.0F, 10.0F, 0.0F);
      this.setRotateAngle(this.neck_1, 0.13665928F, 0.0F, 0.0F);
   ...
   public Iterable<AdvancedModelBox> getAllParts() {
      return ImmutableList.of(
         this.body_main,
         this.leg_left_thigh,
         this.body_hump_front,
         this.arm_left_1,
         this.neck_1,
         this.body_hump_back,
         this.body_hump_centre,
         this.arm_right_1,
   ...
   private void animate(IAnimatedEntity entityIn) {
      ...
      this.animator.setAnimation(EntityCamel.IDLE_TALK);
      this.animator.startKeyframe(10);
      this.rotate(this.animator, this.neck_1, -5.22F, 0.0F, 0.0F);
      this.rotate(this.animator, this.neck_2, -20.0F, 0.0F, 0.0F);
      this.rotate(this.animator, this.head_nose_1, 26.09F, 0.0F, 0.0F);
      this.rotate(this.animator, this.head_main, -26.09F, 0.0F, 0.0F);
      this.animator.endKeyframe();
      this.animator.resetKeyframe(10);
      this.animator.setAnimation(EntityCamel.ATTACK_SPIT);
      this.animator.startKeyframe(6);
      this.rotate(this.animator, this.neck_1, 5.22F, 0.0F, 0.0F);
      this.rotate(this.animator, this.neck_2, -46.96F, 0.0F, 0.0F);
      this.animator.move(this.head_main, 0.0F, 2.0F, 0.0F);
      this.rotate(this.animator, this.head_main, 15.65F, 0.0F, 0.0F);
      this.animator.endKeyframe();
      this.animator.startKeyframe(4);
      this.rotate(this.animator, this.neck_2, 46.96F, 0.0F, 0.0F);
      this.animator.move(this.head_main, 0.0F, 2.0F, 0.0F);
      this.rotate(this.animator, this.head_main, -28.7F, 0.0F, 0.0F);
      this.animator.move(this.head_nose, 0.0F, 0.0F, 1.5F);
      this.rotate(this.animator, this.head_nose, -28.7F, 0.0F, 0.0F);
      this.rotate(this.animator, this.head_nose, 36.52F, 0.0F, 0.0F);
      this.animator.endKeyframe();
   ...
   public void setupAnim(EntityCamel camel, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (camel.isNoAi()) {
         limbSwing = (float)camel.tickCount / 4.0F;
      ...
      this.bob(this.leg_right_calf, 0.4F * globalSpeed, 0.1F, false, -ageInTicks / 20.0F, 2.0F);
      this.bob(this.leg_left_calf, 0.4F * globalSpeed, 0.1F, false, -ageInTicks / 20.0F, 2.0F);
      this.walk(this.neck_1, 0.4F * globalSpeed, 0.03F, false, 2.4F, 0.08F, ageInTicks / 20.0F, 2.0F);
      if (camel.sleepProgress == 0) {
         this.walk(this.neck_2, 0.4F * globalSpeed, 0.03F, false, 2.8F, 0.06F, ageInTicks / 20.0F, 2.0F);
      }
      ...
      if (!camel.isSleeping()) {
         this.faceTarget(netHeadYaw, headPitch, 4.0F, new AdvancedModelBox[]{this.neck_1});
         this.faceTarget(netHeadYaw, headPitch, 4.0F, new AdvancedModelBox[]{this.neck_2});
         this.faceTarget(netHeadYaw, headPitch, 3.0F, new AdvancedModelBox[]{this.head_main});
      }

      if (camel.isInWater() && !camel.onGround()) {
         float pitch = Mth.clamp(camel.getXRot(), -20.0F, 20.0F) - 10.0F;
         this.setRotateAngle(this.body_main, (float)((double)pitch * Math.PI / 180.0), 0.0F, 0.0F);
      }

      if (camel.canMove()) {
         if (!(camel.getCurrentSpeed() > 0.1F) && !camel.isAngry()) {
            this.flap(this.body_main, 0.5F * globalSpeed, 0.2F, false, 0.0F, 0.0F, limbSwing, limbSwingAmount);
            this.flap(this.neck_1, 0.5F * globalSpeed, 0.2F, true, 0.2F, 0.0F, limbSwing, limbSwingAmount);
            ...
            this.walk(this.leg_right_calf_1, 0.5F * globalSpeed, 0.6F * globalDegree, true, 0.4F, 0.2F, limbSwing, limbSwingAmount);
            this.bob(this.leg_left_thigh, 0.5F * globalSpeed, 0.8F, false, limbSwing, limbSwingAmount);
            this.walk(this.leg_left_thigh, 0.5F * globalSpeed, globalDegree, true, 2.6F, 0.0F, limbSwing, limbSwingAmount);
            this.walk(this.leg_left_calf_1, 0.5F * globalSpeed, 0.6F * globalDegree, true, 2.8F, 0.2F, limbSwing, limbSwingAmount);
         } else {
            ...
            this.walk(this.neck_1, 0.5F * globalSpeed, -0.5F * globalDegree, true, 0.5F, 0.0F, limbSwing, limbSwingAmount);
            this.walk(this.neck_2, 0.5F * globalSpeed, 0.3F * globalDegree, false, 0.5F, 0.0F, limbSwing, limbSwingAmount);
            this.bob(this.arm_right_1, 0.5F * globalSpeed, 0.8F, false, limbSwing, limbSwingAmount);
            ...
            this.bob(this.leg_right_calf, 0.5F * globalSpeed, 0.8F, false, limbSwing, limbSwingAmount);
            this.walk(this.leg_right_calf, 0.5F * globalSpeed, 1.0F * globalDegree, true, 1.4F, 0.0F, limbSwing, limbSwingAmount);
            this.walk(this.leg_right_calf_1, 0.5F * globalSpeed, 0.6F * globalDegree, true, 1.6F, 0.2F, limbSwing, limbSwingAmount);
            this.bob(this.leg_left_calf, 0.5F * globalSpeed, 0.8F, false, limbSwing, limbSwingAmount);
            this.walk(this.leg_left_calf, 0.5F * globalSpeed, 1.0F * globalDegree, true, 2.0F, 0.0F, limbSwing, limbSwingAmount);
            this.walk(this.leg_left_calf_1, 0.5F * globalSpeed, 0.6F * globalDegree, true, 2.2F, 0.2F, limbSwing, limbSwingAmount);
         }
      }

      if (camel.sitProgress > 0) {
         this.progressPosition(this.body_main, (float)camel.sitProgress, 0.0F, 15.3F, 0.0F, 40.0F);
         this.progressRotation(this.neck_1, (float)camel.sitProgress, 0.0F, 0.0F, 0.0F, 40.0F);
         this.progressRotation(this.arm_left_1, (float)camel.sitProgress, (float)Math.toRadians(-26.09), 0.0F, (float)Math.toRadians(-10.43), 40.0F);
         this.progressRotation(
            this.arm_left_2, (float)camel.sitProgress, (float)Math.toRadians(112.17), (float)Math.toRadians(-2.61), (float)Math.toRadians(10.43), 40.0F
         );
         this.progressRotation(this.arm_right_1, (float)camel.sitProgress, (float)Math.toRadians(-26.09), 0.0F, (float)Math.toRadians(10.43), 40.0F);
         this.progressRotation(
            this.arm_right_2, (float)camel.sitProgress, (float)Math.toRadians(112.17), (float)Math.toRadians(2.61), (float)Math.toRadians(-10.43), 40.0F
         );
         this.progressPosition(this.leg_left_thigh, (float)camel.sitProgress, 3.8F, -3.0F, 11.5F, 40.0F);
         this.progressRotation(
            this.leg_left_thigh, (float)camel.sitProgress, (float)Math.toRadians(-7.83), (float)Math.toRadians(-5.22), (float)Math.toRadians(-7.83), 40.0F
         );
         this.progressRotation(this.leg_left_calf, (float)camel.sitProgress, (float)Math.toRadians(-54.78F), 0.0F, 0.0F, 40.0F);
         this.progressRotation(this.leg_left_calf_1, (float)camel.sitProgress, (float)Math.toRadians(161.74), 0.0F, 0.0F, 40.0F);
         this.progressPosition(this.leg_right_thigh, (float)camel.sitProgress, -3.8F, -3.0F, 11.5F, 40.0F);
         this.progressRotation(
            this.leg_right_thigh, (float)camel.sitProgress, (float)Math.toRadians(-7.83), (float)Math.toRadians(5.22), (float)Math.toRadians(7.83), 40.0F
         );
         this.progressRotation(this.leg_right_calf, (float)camel.sitProgress, (float)Math.toRadians(-54.78F), 0.0F, 0.0F, 40.0F);
         this.progressRotation(this.leg_right_calf_1, (float)camel.sitProgress, (float)Math.toRadians(161.74), 0.0F, 0.0F, 40.0F);
      }

      if (camel.sleepProgress > 0) {
         this.progressPosition(this.body_main, (float)camel.sleepProgress, 0.0F, 15.3F, 0.0F, 40.0F);
         this.progressRotation(this.neck_1, (float)camel.sleepProgress, (float)Math.toRadians(16.0), 0.0F, 0.0F, 40.0F);
         this.progressRotation(this.neck_2, (float)camel.sleepProgress, (float)Math.toRadians(-2.61), 0.0F, 0.0F, 40.0F);
         this.progressPosition(this.head_main, (float)camel.sleepProgress, 0.0F, 2.6F, -8.3F, 40.0F);
         this.progressRotation(this.head_main, (float)camel.sleepProgress, (float)Math.toRadians(-13.04), 0.0F, 0.0F, 40.0F);
         this.progressRotation(this.arm_left_1, (float)camel.sleepProgress, (float)Math.toRadians(-26.09), 0.0F, (float)Math.toRadians(-10.43), 40.0F);
         this.progressRotation(
            this.arm_left_2, (float)camel.sleepProgress, (float)Math.toRadians(112.17), (float)Math.toRadians(-2.61), (float)Math.toRadians(10.43), 40.0F
         );
         this.progressRotation(this.arm_right_1, (float)camel.sleepProgress, (float)Math.toRadians(-26.09), 0.0F, (float)Math.toRadians(10.43), 40.0F);
         this.progressRotation(
            this.arm_right_2, (float)camel.sleepProgress, (float)Math.toRadians(112.17), (float)Math.toRadians(2.61), (float)Math.toRadians(-10.43), 40.0F
         );
         this.progressPosition(this.leg_left_thigh, (float)camel.sleepProgress, 3.8F, -3.0F, 11.5F, 40.0F);
         this.progressRotation(
            this.leg_left_thigh, (float)camel.sleepProgress, (float)Math.toRadians(-7.83), (float)Math.toRadians(-5.22), (float)Math.toRadians(-7.83), 40.0F
         );
         this.progressRotation(this.leg_left_calf, (float)camel.sleepProgress, (float)Math.toRadians(-54.78F), 0.0F, 0.0F, 40.0F);
         this.progressRotation(this.leg_left_calf_1, (float)camel.sleepProgress, (float)Math.toRadians(161.74), 0.0F, 0.0F, 40.0F);
         this.progressPosition(this.leg_right_thigh, (float)camel.sleepProgress, -3.8F, -3.0F, 11.5F, 40.0F);
         this.progressRotation(
            this.leg_right_thigh, (float)camel.sleepProgress, (float)Math.toRadians(-7.83), (float)Math.toRadians(5.22), (float)Math.toRadians(7.83), 40.0F
         );
         this.progressRotation(this.leg_right_calf, (float)camel.sleepProgress, (float)Math.toRadians(-54.78F), 0.0F, 0.0F, 40.0F);
         this.progressRotation(this.leg_right_calf_1, (float)camel.sleepProgress, (float)Math.toRadians(161.74), 0.0F, 0.0F, 40.0F);
      } else {
         this.flap(this.tail, 0.4F * globalSpeed, 0.2F * globalDegree, true, 0.0F, 0.0F, ageInTicks / 6.0F, 2.0F);
      }
   }
}
