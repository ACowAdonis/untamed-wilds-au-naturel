...
public class ModelRhinoCalf extends AdvancedEntityModel<EntityRhino> {
   ...
   public ModelRhinoCalf() {
      ...
      this.leg_left.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, 0.0F);
      ...
      this.body_head.addBox(-2.5F, -3.0F, -8.0F, 5.0F, 6.0F, 9.0F, 0.0F);
      this.setRotateAngle(this.body_head, 0.63739425F, 0.0F, 0.0F);
      this.ear_left = new AdvancedModelBox(this, 0, 37);
      this.ear_left.setRotationPoint(2.5F, -2.0F, -5.0F);
      this.ear_left.addBox(-1.0F, -3.0F, 4.5F, 2.0F, 3.0F, 1.0F, 0.0F);
      ...
      this.arm_left.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, 0.0F);
      this.setRotateAngle(this.arm_left, 0.22759093F, 0.0F, 0.0F);
      this.horn_back = new AdvancedModelBox(this, 11, 14);
      this.horn_back.setRotationPoint(0.0F, 0.0F, -5.7F);
      this.horn_back.addBox(-1.0F, -4.0F, -1.5F, 2.0F, 2.0F, 3.0F, 0.0F);
      this.setRotateAngle(this.horn_back, 0.31869712F, 0.0F, 0.0F);
   ...
   public void setupAnim(EntityRhino rhino, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (!rhino.isSleeping()) {
         this.faceTarget(netHeadYaw, headPitch, 2.0F, new AdvancedModelBox[]{this.body_head});
      }
