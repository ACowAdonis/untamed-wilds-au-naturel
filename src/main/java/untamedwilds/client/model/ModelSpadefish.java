...
public class ModelSpadefish extends AdvancedEntityModel<EntitySpadefish> {
   ...
   public ModelSpadefish() {
      ...
      this.fin_pec_right.addBox(0.0F, 0.0F, 0.0F, 0.0F, 5.0F, 2.0F, 0.0F);
      this.setRotateAngle(this.fin_pec_right, 0.27314404F, 0.0F, 0.27314404F);
      this.body_tail = new AdvancedModelBox(this, 0, 5);
      this.body_tail.setRotationPoint(0.0F, 0.0F, 6.0F);
      this.body_tail.addBox(-1.0F, -1.5F, 0.0F, 2.0F, 3.0F, 2.0F, 0.0F);
      this.fin_side_left = new AdvancedModelBox(this, 20, 15);
      this.fin_side_left.setRotationPoint(1.5F, 1.0F, -1.0F);
      this.fin_side_left.addBox(0.0F, -1.0F, 0.0F, 0.0F, 2.0F, 5.0F, 0.0F);
      this.setRotateAngle(this.fin_side_left, 0.0F, 0.3642502F, 0.0F);
      this.fin_bottom = new AdvancedModelBox(this, 16, 16);
      this.fin_bottom.setRotationPoint(0.0F, 2.0F, 3.0F);
      this.fin_bottom.addBox(0.0F, 0.0F, -4.0F, 0.0F, 8.0F, 8.0F, 0.0F);
      this.setRotateAngle(this.fin_bottom, 0.27314404F, 0.0F, 0.0F);
      this.body_hump = new AdvancedModelBox(this, 22, 0);
      this.body_hump.setRotationPoint(0.0F, -3.0F, -1.0F);
      this.body_hump.addBox(-1.0F, 0.0F, 0.0F, 2.0F, 7.0F, 3.0F, 0.0F);
      this.setRotateAngle(this.body_hump, 1.4570009F, 0.0F, 0.0F);
      this.fin_top = new AdvancedModelBox(this, 0, 16);
      this.fin_top.setRotationPoint(0.0F, -2.5F, 3.0F);
      this.fin_top.addBox(0.0F, -8.0F, -4.0F, 0.0F, 8.0F, 8.0F, 0.0F);
      this.setRotateAngle(this.fin_top, -0.27314404F, 0.0F, 0.0F);
      this.main_body = new AdvancedModelBox(this, 0, 0);
      this.main_body.setRotationPoint(0.0F, 21.0F, -2.0F);
      this.main_body.addBox(-1.4F, -4.0F, -4.0F, 3.0F, 8.0F, 10.0F, 0.0F);
      this.fin_pec_left = new AdvancedModelBox(this, 0, -2);
      this.fin_pec_left.setRotationPoint(0.5F, 3.5F, -3.0F);
      this.fin_pec_left.addBox(0.0F, 0.0F, 0.0F, 0.0F, 5.0F, 2.0F, 0.0F);
      this.setRotateAngle(this.fin_pec_left, 0.27314404F, 0.0F, -0.27314404F);
      this.fin_side_right = new AdvancedModelBox(this, 20, 15);
      this.fin_side_right.setRotationPoint(-1.5F, 1.0F, -1.0F);
      this.fin_side_right.addBox(0.0F, -1.0F, 0.0F, 0.0F, 2.0F, 5.0F, 0.0F);
      this.setRotateAngle(this.fin_side_right, 0.0F, -0.3642502F, 0.0F);
      this.fin_tail = new AdvancedModelBox(this, 12, 14);
      this.fin_tail.setRotationPoint(0.0F, 0.0F, 0.5F);
      this.fin_tail.addBox(0.0F, -3.0F, 0.0F, 0.0F, 6.0F, 4.0F, 0.0F);
   ...
   public void setupAnim(EntitySpadefish spadefish, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      AdvancedModelBox[] bodyParts = new AdvancedModelBox[]{this.main_body, this.body_tail, this.fin_tail};
      ...
      this.swing(this.fin_pec_left, globalSpeed, globalDegree * 0.8F, false, 0.0F, 0.2F, ageInTicks / 6.0F, 0.6F);
      this.swing(this.fin_pec_right, globalSpeed, globalDegree * 0.8F, true, 0.0F, 0.2F, ageInTicks / 6.0F, 0.6F);
   }
}
