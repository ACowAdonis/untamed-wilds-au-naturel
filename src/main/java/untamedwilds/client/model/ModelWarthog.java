...
public class ModelWarthog extends AdvancedEntityModel<EntityBoar> {
   ...
   public ModelWarthog() {
      ...
      this.tusk_right.addBox(0.0F, -2.0F, -1.0F, 1.0F, 3.0F, 2.0F, 0.0F);
      this.setRotateAngle(this.tusk_right, 0.0F, -0.045553092F, -1.1838568F);
      ...
      this.tusk_left.addBox(-1.0F, -2.0F, -1.0F, 1.0F, 3.0F, 2.0F, 0.0F);
      this.setRotateAngle(this.tusk_left, 0.0F, 0.045553092F, 1.1838568F);
      ...
      this.arm_left_1.addBox(-1.5F, 0.0F, -2.0F, 3.0F, 5.0F, 4.0F, 0.0F);
      ...
      this.cheek_right.addBox(-3.0F, -1.0F, -1.5F, 3.0F, 2.0F, 3.0F, 0.0F);
      this.setRotateAngle(this.cheek_right, 0.0F, 0.0F, -0.31869712F);
      this.head_main = new AdvancedModelBox(this, 0, 22);
      this.head_main.setRotationPoint(0.0F, -1.3F, -8.0F);
      this.head_main.addBox(-2.5F, -4.0F, -4.0F, 5.0F, 6.0F, 6.0F, 0.0F);
      ...
      this.leg_left_1.addBox(-2.0F, -1.0F, -2.0F, 3.0F, 5.0F, 4.0F, 0.0F);
      this.setRotateAngle(this.leg_left_1, -0.13665928F, 0.0F, -0.14695673F);
      ...
      this.arm_right_1.addBox(-1.5F, 0.0F, -2.0F, 3.0F, 5.0F, 4.0F, 0.0F);
      ...
      this.head_snout.addBox(-2.5F, -1.5F, -4.0F, 5.0F, 3.0F, 5.0F, 0.0F);
      this.setRotateAngle(this.head_snout, 0.3642502F, 0.0F, 0.0F);
      this.main_body = new AdvancedModelBox(this, 0, 0);
      this.main_body.setRotationPoint(0.0F, 17.0F, 0.0F);
      this.main_body.addBox(-3.0F, -5.0F, -8.0F, 6.0F, 7.0F, 14.0F, 0.0F);
      ...
      this.cheek_left.addBox(0.0F, -1.0F, -1.5F, 3.0F, 2.0F, 3.0F, 0.0F);
      this.setRotateAngle(this.cheek_left, 0.0F, 0.0F, 0.31869712F);
      ...
      this.leg_right_1.addBox(-1.0F, -1.0F, -2.0F, 3.0F, 5.0F, 4.0F, 0.0F);
