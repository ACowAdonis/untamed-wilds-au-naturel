...
public class SmartWanderGoal extends Goal {
   ...
   public boolean canUse() {
      if (this.creature.canMove()
         && this.creature.getNavigation().isDone()
         && this.creature.getCommandInt() == 0
         && this.creature.getRandom().nextInt(this.executionChance) == 0) {
   ...
   public void start() {
      this.creature.getNavigation().moveTo(this.x, this.y, this.z, this.speed * (double)(this.creature.getRandom().nextInt(100) < this.runChance ? 2.0F : 1.0F));
   }
}
