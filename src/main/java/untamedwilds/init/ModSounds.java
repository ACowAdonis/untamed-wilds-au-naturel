...
public class ModSounds {
   public static final DeferredRegister<SoundEvent> SOUNDS = DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, "untamedwilds");
   ...
   public static final SoundEvent ENTITY_RHINO_AMBIENT = registerSound("entity.rhino.ambient");
   public static final SoundEvent ENTITY_RHINO_HURT = registerSound("entity.rhino.hurt");
   public static final SoundEvent ENTITY_RHINO_DEATH = registerSound("entity.rhino.death");
   ...
   public static final SoundEvent ENTITY_WILDEBEEST_AMBIENT = registerSound("entity.wildebeest.ambient");
   public static final SoundEvent ENTITY_WILDEBEEST_HURT = registerSound("entity.wildebeest.hurt");
   public static final SoundEvent ENTITY_WILDEBEEST_DEATH = registerSound("entity.wildebeest.death");
   ...
   public static final SoundEvent ENTITY_TERROR_BIRD_AMBIENT = registerSound("entity.terror_bird.ambient");
   public static final SoundEvent ENTITY_TERROR_BIRD_HURT = registerSound("entity.terror_bird.hurt");
   public static final SoundEvent ENTITY_TERROR_BIRD_DEATH = registerSound("entity.terror_bird.death");
   public static final SoundEvent ENTITY_TERROR_BIRD_THREAT = registerSound("entity.terror_bird.threat");
   public static final SoundEvent NOTHING = registerSound("nothing");

   private static SoundEvent registerSound(String soundName) {
      ResourceLocation location = new ResourceLocation("untamedwilds", soundName);
